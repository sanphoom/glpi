...
if (isset($_GET['getvcard'])) {
   ...
   $contact->check($_GET["id"], ProfileRight::READ);
   $contact->generateVcard();

} else if (isset($_POST["add"])) {
   $contact->check(-1, ProfileRight::CREATE, $_POST);
   ...
   $contact->check($_POST["id"], ProfileRight::DELETE);
   ...
   $contact->check($_POST["id"], ProfileRight::PURGE);
   ...
   $contact->check($_POST["id"], ProfileRight::UPDATE);
